...
export const generatePDF = async (roadmapContent, userInputs) => {
    try {
        ...
        container.innerHTML = `
            ...
            <div style="margin-top: 40px; border-top: 1px solid #e2e8f0; padding-top: 20px; text-align: center; color: #94a3b8; font-size: 10px; font-style: italic;">
                Generated by CareerFix.AI • ${new Date().toLocaleDateString()}
            </div>
        `;
